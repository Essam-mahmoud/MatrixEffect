...
struct MatrixRainCharacters: View {
    ...
    var body: some View {
        let randomHeigh: CGFloat = .random(in: (size.height / 2)...size.height)
        VStack {
        ...
        .mask(alignment: .top){
            Rectangle()
                ...
                .offset(y: startAnimation ? size.height : -randomHeigh)
        }
        .onAppear {
...
let constant = "absdhfjeiyuwomvbfhjeh234bdxnfjklfn094nmfjkmkwdweufwkjnf"
